...
public class MediaController {
    ...
    @PostMapping("upload")
    public /*Map<String, String>*/ String uploadFile(@RequestParam("file") MultipartFile multipartfile) {
    ...
    public Integer AgregaEmpleados(List <Double> dEmpleados) throws IOException {
        Integer tam = dEmpleados.size();
        System.out.print("tamaño:" + tam);
        //String pb;
        for (int i = 0; i < tam; i++) {
            System.out.println(dEmpleados.get(i));
            nempleadoService.addEmpleados(dEmpleados.get(i));
